    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="rounded-lg border p-4">
          ...
          <p className="mt-1 text-xl font-semibold tabular-nums">{formatMoney(payroll.netPayable)}</p>
        </div>
        <div className="rounded-lg border p-4">
        ...
        <div className="rounded-lg border p-4">
          <p className="text-muted-foreground text-xs font-medium">Hours</p>
          <p className="mt-1 text-lg font-medium tabular-nums">
            {Number(payroll.regularHours).toFixed(1)} reg / {Number(payroll.overtimeHours).toFixed(1)} OT
          </p>
        </div>
      </div>
